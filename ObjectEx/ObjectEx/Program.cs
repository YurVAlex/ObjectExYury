...
internal class Program
{
    ...
    {
        var p1 = new Person("Yury", 41);
        var p2 = new Person("Alex", 33);
        var p3 = new Person("Yury", 41);
        var p4 = new Person("Alex", 50);
        ...
        Console.WriteLine();
        Console.WriteLine("p3 become null");
        p3 = null;
        Console.WriteLine($"p1.Equals(p3): {p1.Equals(p3)}");
        Console.WriteLine($"p1 == p3: {p1 == p3}");
        Console.WriteLine($"p1 != p3: {p1 != p3}");
        Console.WriteLine($"p3 != p1: {p3 != p1}");
        Console.WriteLine($"p1 > p3: {p1 > p3}");
        Console.WriteLine($"p1 < p3: {p1 < p3}");

        Console.WriteLine();
        Console.WriteLine("p2 become null");
        p2 = null;
